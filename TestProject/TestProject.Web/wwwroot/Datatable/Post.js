        ...
        var datatable = $('#kt_datatable').KTDatatable({
                ...
                },
            {
                ...
                template: function (data) {
                    ...
                    buttons = buttons +  '\<a  href ="/Post/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.tilte + ' ">\
...
<a class="btn btn-primary PopUp" href="/Post/GetLog/' + data.id + '">عرض</a>';
                    if (data.status == 'Pending') {
                        buttons = buttons + '<a href="/Post/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="قبول" >\
