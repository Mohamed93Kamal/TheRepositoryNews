            ...
            columns: [
                ...
                
                {
                    ...
                    template: function (data) {
                        ...
                        buttons = buttons + '\<a  href ="/Track/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.tilte + ' ">\
                        ...
                        if (data.status == 'Pending') {
                            buttons = buttons + '<a href="/Track/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="قبول" >\
                        ...
                        <a href="/Track/UpdateStatus/' + data.id + '?status=3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="رفض" >\
                            ...
                            buttons = buttons + '<a href="/Track/UpdateStatus/' + data.id + '?status=3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="رفض" >\
                            <span class="svg-icon svg-icon-danger svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Error-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                <g stroke="none" stroke - width="1" fill = "none" fill - rule="evenodd" >\
                                <rect x="0" y="0" width="24" height="24" />\
                                <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />\
