...
{
    public partial class information_One : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChaneAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_postAttatchments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_postAttatchments_posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_postAttatchments_PostId",
                table: "postAttatchments",
                column: "PostId");
